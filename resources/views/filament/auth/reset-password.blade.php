    ...
    <div class="flex flex-1 flex-col justify-center px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-24 bg-[#060e20] relative overflow-hidden">
        ...
        <div class="mx-auto w-full max-w-sm lg:w-96 relative z-10">
            <div class="mb-10 text-center lg:text-left">
                ...
                <h2 style="font-family: 'Plus Jakarta Sans', sans-serif;" class="text-3xl font-bold tracking-tight text-[#dee5ff]">Set New Password</h2>
                <p style="font-family: 'Manrope', sans-serif;" class="mt-2 text-sm text-[#a3aac4]">Use a strong password you have not used before.</p>
            </div>
